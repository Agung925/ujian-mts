    ...
    <div class="w-full max-w-md" x-data="{ showPass: false }">
        <div class="bg-white rounded-2xl shadow-xl p-8">
            <div class="text-center mb-8">
                <div class="inline-flex items-center justify-center w-32 h-32 rounded-full bg-transparent border-2 border-white/40 mb-6 p-3">
                    <img src="{{ asset('images/mts-al-hidayah-logo.png') }}" 
                         alt="Logo {{ config('app.name') }}"
                         class="w-full h-full object-contain"
                         onerror="this.style.display='none';this.nextElementSibling.style.display='block'">
                    <svg class="w-16 h-16 text-white hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
