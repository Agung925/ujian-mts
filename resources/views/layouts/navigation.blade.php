        ...
        <div class="flex items-center justify-between h-16">
            ...
            <a href="{{ $dashboardRoute }}"
               class="flex items-center gap-3 shrink-0 group">
                {{-- Logo MTs Al-Hidayah Tamansari (Match Footer Styling) --}}
                <div class="w-9 h-9 rounded-md overflow-hidden shadow-md bg-white dark:bg-gray-800 flex items-center justify-center shrink-0 border border-gray-200 dark:border-gray-700
