...
<div class="max-w-lg mx-auto px-4 py-8">
    <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-6">Tambah Mata Pelajaran</h1>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
        <form method="POST" action="{{ route('admin.mata-pelajaran.store') }}">
            ...
            <div class="mb-4">
                ...
                <p class="text-gray-400 dark:text-gray-500 text-xs mt-1">Kode singkat, maks 10 karakter. Harus unik.</p>
