...
<div class="max-w-6xl mx-auto px-4 py-8">
                ...
                <form method="POST" action="{{ route('admin.kelas.simpan-assign-siswa', $kelas) }}">
                    ...
                    <div class="px-4 py-3 border-b">
                        <input type="text" x-model="search" placeholder="Cari nama / NIS..."
                               class="w-full border border-gray-200 rounded px-3 py-1.5 text-sm focus:ring-2 focus:ring-green-500">
                    </div>
                    ...
                    <div class="max-h-80 overflow-y-auto divide-y divide-gray-100">
                        ...
                        <label class="flex items-center gap-3 px-4 py-2.5 hover:bg-gray-50 cursor-pointer"
                            ...
                            <div>
                                <p class="text-sm font-medium text-gray-800">{{ $siswa->name }}</p>
    ...
    <div class="mt-6">
        <a href="{{ route('admin.kelas.index') }}" class="text-sm text-gray-500 hover:text-gray-700">
