    ...
    <main class="max-w-2xl mx-auto px-4 py-8">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div class="flex items-center gap-4 mb-6 pb-6 border-b border-gray-100 dark:border-gray-700">
                ...
                <div>
                    <h1 class="text-xl font-bold text-gray-800 dark:text-gray-100">Edit: {{ $user->name }}</h1>
            ...
            <form method="POST" action="{{ route('admin.users.update', $user) }}"
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <button type="button" @click="isAktif = !isAktif"
                            ...
                            <span :class="isAktif ? 'translate-x-5' : 'translate-x-1'"
                                class="inline-block w-4 h-4 mt-1 bg-white dark:bg-gray-800 rounded-full shadow transition-transform duration-200"></span>
                ...
                <div class="border-t border-gray-100 dark:border-gray-700 pt-4 mb-6" x-data="{ show: false }">
                    <p class="text-sm text-gray-500 dark:text-gray-400 mb-3">Kosongkan jika tidak ingin mengganti password.</p>
            ...
            <div class="mt-6 pt-6 border-t border-gray-100 dark:border-gray-700" x-data="{ preview: '{{ $user->foto ? Storage::url($user->foto) : '' }}' }">
                <h3 class="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Upload Foto Profil</h3>
                ...
                <form method="POST" action="{{ route('admin.users.upload-foto', $user) }}" enctype="multipart/form-data"
                    ...
                    <input type="file" name="foto" accept="image/jpg,image/jpeg,image/png,image/webp" required
                           class="flex-1 text-sm text-gray-600 dark:text-gray-400 file:mr-3 file:py-1.5 file:px-3 file:rounded-lg file:border-0 file:bg-green-50 file:text-green-700 file:text-xs file:font-semibold hover:file:bg-green-100 cursor-pointer"
                           @change="
