        ...
        <form method="POST" action="{{ route('guru.ujian.store') }}">
            ...
            <div class="mb-6">
                ...
                <textarea name="deskripsi" rows="3"
                          ...
                          class="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-green-500 focus:outline-none resize-none">{{ old('deskripsi') }}</textarea>
            </div>
