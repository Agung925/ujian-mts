...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="flex items-center gap-3 mb-6">
        <a href="{{ route('guru.ujian.show', $ujian) }}" class="text-gray-400 hover:text-gray-600">
    ...
    {{-- Info read-only --}}
    <div class="mb-4 p-4 bg-gray-50 border border-gray-200 rounded-lg grid grid-cols-2 gap-4 text-sm">
        <div>
        ...
        <form method="POST" action="{{ route('guru.ujian.update', $ujian) }}"
            ...
            <div class="mb-6">
                ...
                <textarea name="deskripsi" rows="3"
                          class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-green-500 focus:outline-none resize-none">{{ old('deskripsi', $ujian->deskripsi) }}</textarea>
            </div>
