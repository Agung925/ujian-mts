...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./workdir/www/ujian-mts/public/storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./workdir/www/ujian-mts/public/storage','logging.default',
...
'signed','throttle','verified','role.superadmin','role.guru',
'role.siswa',);
        registerArgumentsSet('routes', 'admin.dashboard','admin.users.template-excel','admin.users.import-siswa',
'admin.users.index','admin.users.create','admin.users.store','admin.users.show','admin.users.edit',
'admin.users.update','admin.users.destroy','admin.tahun-ajaran.aktifkan','admin.tahun-ajaran.index','admin.tahun-ajaran.create',
'admin.tahun-ajaran.store','admin.tahun-ajaran.show','admin.tahun-ajaran.edit','admin.tahun-ajaran.update','admin.tahun-ajaran.destroy',
'admin.mata-pelajaran.index','admin.mata-pelajaran.create','admin.mata-pelajaran.store','admin.mata-pelajaran.show','admin.mata-pelajaran.edit',
'admin.mata-pelajaran.update','admin.mata-pelajaran.destroy','admin.kelas.assign-siswa','admin.kelas.simpan-assign-siswa','admin.kelas.index',
'admin.kelas.create','admin.kelas.store','admin.kelas.show','admin.kelas.edit','admin.kelas.update',
'admin.kelas.destroy','admin.guru-mapel.index','admin.guru-mapel.store','admin.bank-soal.index','guru.dashboard',
'guru.data-master.kelas','guru.data-master.mata-pelajaran','guru.bank-soal.form-import','guru.bank-soal.proses-import','guru.bank-soal.template-excel',
'guru.bank-soal.index','guru.bank-soal.create','guru.bank-soal.store','guru.bank-soal.show','guru.bank-soal.edit',
'guru.bank-soal.update','guru.bank-soal.destroy','guru.ujian.index','guru.ujian.create','guru.ujian.store',
'guru.ujian.show','guru.ujian.edit','guru.ujian.update','guru.ujian.destroy','guru.ujian.tambah-soal-manual',
'guru.ujian.tambah-soal-random','guru.ujian.hapus-soal','guru.ujian.buka','guru.ujian.tutup','guru.ujian.detail-siswa',
'guru.ujian.rekap-nilai','guru.ujian.koreksi-essay','guru.ujian.export-excel','guru.ujian.export-pdf','siswa.dashboard',
'siswa.ujian.masuk','siswa.ujian.ruang','siswa.ujian.jawab','siswa.ujian.pelanggaran','siswa.ujian.submit',
'siswa.ujian.hasil','register','login',
...
'logout','profile.edit','profile.update','profile.destroy','storage.local',
'storage.local.upload',);
        registerArgumentsSet('views', 
'admin.bank_soal.index','admin.dashboard','admin.guru_mapel.index','admin.kelas.assign_siswa','admin.kelas.create',
'admin.kelas.edit','admin.kelas.index','admin.mata_pelajaran.create','admin.mata_pelajaran.edit','admin.mata_pelajaran.index',
'admin.tahun_ajaran.create','admin.tahun_ajaran.edit','admin.tahun_ajaran.index','admin.users.create','admin.users.edit',
...
'dashboard','guru.bank_soal.create','guru.bank_soal.edit','guru.bank_soal.import','guru.bank_soal.index',
'guru.bank_soal.show','guru.dashboard','guru.data_master.kelas','guru.data_master.mata_pelajaran','guru.ujian.cetak_nilai',
'guru.ujian.create','guru.ujian.detail_siswa','guru.ujian.edit','guru.ujian.index','guru.ujian.rekap_nilai',
'guru.ujian.show','layouts.app','layouts.guest','layouts.navigation','profile.edit',
'profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','siswa.dashboard','siswa.ujian.hasil',
'siswa.ujian.ruang','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
